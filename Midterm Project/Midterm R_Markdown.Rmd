...
deathsbyyear_c <- group_by(.data = final_df, Country.x)
...
air1 <- ggplot(data = topdeaths_c,
             mapping = aes(x = total, y = reorder(Country.x , total), color = "darkorange3")) +
      ...
      geom_point() +
         ...
         # scale_color_manual(values = c("darkorange3", "firebrick1","lightpink1","green3","dodgerblue4","gold1")) 
...
air2 <- ggplot(data = lowdeaths_c,
             mapping = aes(x = total, y = reorder(Country.x , -total, color = "green4"))) +
      geom_segment(data = lowdeaths_c,
               mapping = aes(x = 0, xend = total, y = reorder(Country.x, -total), yend = Country.x)) +
      geom_point() +
          scale_x_continuous(limits = c(0, 8000), breaks = seq(0,8000,1000)) 
        #  scale_color_manual(values = c("darkorange3", "firebrick1","lightpink1","green3","dodgerblue4","gold1", "mediumorchid1", "azure4","sienna3")) 

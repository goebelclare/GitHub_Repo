...
```{r 5.2.5, include=TRUE, fig.align="center"}
ggplot(final_df_sf, aes(gdp.per.capita, Deaths.Air.Pollution.per.100k)) +
...
```{r 5.4, include=TRUE, fig.align="center"}
